...
{!! Form::textarea('notes', 'By default,other users can see your goals.',['class'=>'form-control']) !!}</p> <!--default is null -->
<p> D)&nbsp I am better in:</p>
 ...
 &nbsp{!! Form::checkbox('improve','Net aerobic routines'); !!} Find new aerobic routines <br>
<br><br>
